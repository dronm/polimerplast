...
function Warehouse_Model(options){
	var id = 'Warehouse_Model';
	options = options || {};
	...
	options.fields.default_firm_id = new FieldInt("default_firm_id",filed_options);
	options.fields.default_firm_id.setRequired(true);
