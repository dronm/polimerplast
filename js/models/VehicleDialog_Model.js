...
function VehicleDialog_Model(options){
	...
	options.fields.driver_drive_perm = new FieldString("driver_drive_perm",filed_options);
	...
	options.fields.driver_cel_phone = new FieldString("driver_cel_phone",filed_options);
