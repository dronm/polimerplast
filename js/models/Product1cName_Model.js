...
function Product1cName_Model(options){
	var id = 'Product1cName_Model';
	options = options || {};
	...
	options.fields.name_for_1c.setRequired(true);
	
			
		Product1cName_Model.superclass.constructor.call(this,id,options);
}
