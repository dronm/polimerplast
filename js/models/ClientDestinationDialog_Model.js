...
function ClientDestinationDialog_Model(options){
	var id = 'ClientDestinationDialog_Model';
	options = options || {};
	...
	options.fields.value = new FieldText("value",filed_options);
	
			
		ClientDestinationDialog_Model.superclass.constructor.call(this,id,options);
}
