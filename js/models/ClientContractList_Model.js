...
function ClientContractList_Model(options){
	var id = 'ClientContractList_Model';
	options = options || {};
	...
	options.fields.date_to_descr = new FieldString("date_to_descr",filed_options);
	
		ClientContractList_Model.superclass.constructor.call(this,id,options);
}
