...
function DOCOrderDOCTFCustSurvey_Model(options){
	var id = 'DOCOrderDOCTFCustSurvey_Model';
	options = options || {};
	...
	options.fields.answer_comment = new FieldText("answer_comment",filed_options);
		...
		DOCOrderDOCTFCustSurvey_Model.superclass.constructor.call(this,id,options);
}
