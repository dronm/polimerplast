...
function ProductMeasureUnitList_Model(options){
	var id = 'ProductMeasureUnitList_Model';
	options = options || {};
	...
	options.fields.measure_unit_descr = new FieldString("measure_unit_descr",filed_options);
	...
	options.fields.calc_formula = new FieldText("calc_formula",filed_options);
		...
		ProductMeasureUnitList_Model.superclass.constructor.call(this,id,options);
}
