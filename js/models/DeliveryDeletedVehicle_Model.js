...
function DeliveryDeletedVehicle_Model(options){
	var id = 'DeliveryDeletedVehicle_Model';
	options = options || {};
	...
	options.fields.date.setRequired(true);
		...
		DeliveryDeletedVehicle_Model.superclass.constructor.call(this,id,options);
}
