...
function ProductCustomSizePrice_Model(options){
	var id = 'ProductCustomSizePrice_Model';
	options = options || {};
	...
	options.fields.category = new FieldInt("category",filed_options);
	options.fields.category.setRequired(true);
	...
	options.fields.quant = new FieldFloat("quant",filed_options);
		...
		ProductCustomSizePrice_Model.superclass.constructor.call(this,id,options);
}
