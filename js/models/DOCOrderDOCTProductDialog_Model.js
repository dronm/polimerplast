...
function DOCOrderDOCTProductDialog_Model(options){
	var id = 'DOCOrderDOCTProductDialog_Model';
	options = options || {};
	...
	options.fields.line_number = new FieldInt("line_number",filed_options);
		...
		DOCOrderDOCTProductDialog_Model.superclass.constructor.call(this,id,options);
}
