...
function WarehouseDialog_Model(options){
	var id = 'WarehouseDialog_Model';
	options = options || {};
	...
	options.fields.firm_id = new FieldString("firm_id",filed_options);
	...
	options.fields.production_city_id = new FieldString("production_city_id",filed_options);
