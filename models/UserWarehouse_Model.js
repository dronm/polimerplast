...
function UserWarehouse_Model(options){
	var id = 'UserWarehouse_Model';
	options = options || {};
	...
	options.fields.user_id.setRequired(true);
	...
	options.fields.warehouse_id.setRequired(true);
		...
		UserWarehouse_Model.superclass.constructor.call(this,id,options);
}
