...
class SertTypeAttrList_Model extends ModelSQL{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("sert_types_attrs_list");
		...
		$f_sert_type_descr=new FieldSQlString($this->getDbLink(),$this->getDbName(),$this->getTableName()
		,"sert_type_descr"
		,array(
