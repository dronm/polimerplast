...
function DOCOrderDOCTCustSurveyList_Model(options){
	var id = 'DOCOrderDOCTCustSurveyList_Model';
	options = options || {};
	...
	options.fields.line_number = new FieldInt("line_number",filed_options);
		...
		DOCOrderDOCTCustSurveyList_Model.superclass.constructor.call(this,id,options);
}
