...
function DOCOrderCurrentForProductionList_Model(options){
	var id = 'DOCOrderCurrentForProductionList_Model';
	options = options || {};
	...
	options.fields.is_current = new FieldBool("is_current",filed_options);
		...
		DOCOrderCurrentForProductionList_Model.superclass.constructor.call(this,id,options);
}
