...
class VehicleDialog_Model extends ModelSQL{
	...
	public function __construct($dbLink){
		...
		//*** Field driver_drive_perm ***
		$f_opts = array();
		$f_opts['id']="driver_drive_perm";
				
		$f_driver_drive_perm=new FieldSQLString($this->getDbLink(),$this->getDbName(),$this->getTableName(),"driver_drive_perm",$f_opts);
		$this->addField($f_driver_drive_perm);
		//********************
		
		//*** Field driver_cel_phone ***
		$f_opts = array();
		$f_opts['id']="driver_cel_phone";
				
		$f_driver_cel_phone=new FieldSQLString($this->getDbLink(),$this->getDbName(),$this->getTableName(),"driver_cel_phone",$f_opts);
		$this->addField($f_driver_cel_phone);
		//********************
