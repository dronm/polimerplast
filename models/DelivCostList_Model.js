...
function DelivCostList_Model(options){
	var id = 'DelivCostList_Model';
	options = options || {};
	...
	options.fields.deliv_cost_opt = new FieldInt("deliv_cost_opt",filed_options);
	
				
	
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'Ценовая категория';
	filed_options.autoInc = false;	
	...
	options.fields.deliv_cost_type = new FieldString("deliv_cost_type",filed_options);
	
				
	
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'Город/межгород';
	filed_options.autoInc = false;	
	
	options.fields.deliv_cost_type_descr = new FieldString("deliv_cost_type_descr",filed_options);
