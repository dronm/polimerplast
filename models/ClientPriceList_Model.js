...
function ClientPriceList_Model(options){
	var id = 'ClientPriceList_Model';
	options = options || {};
	...
	options.fields.part_ship_do_not_change_price = new FieldBool("part_ship_do_not_change_price",filed_options);
	...
	options.fields.min_order_quant = new FieldFloat("min_order_quant",filed_options);
	...
	options.fields.default_price_list = new FieldBool("default_price_list",filed_options);
