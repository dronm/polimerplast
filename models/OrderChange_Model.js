...
function OrderChange_Model(options){
	var id = 'OrderChange_Model';
	options = options || {};
	...
	options.fields.old_value = new FieldText("old_value",filed_options);
	
		OrderChange_Model.superclass.constructor.call(this,id,options);
}
