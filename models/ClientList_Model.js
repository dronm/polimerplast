...
function ClientList_Model(options){
	...
	options.fields.occupation = new FieldText("occupation",filed_options);
	...
	options.fields.contract_descr = new FieldString("contract_descr",filed_options);
	...
	options.fields.contract_period = new FieldString("contract_period",filed_options);
	...
	options.fields.terms = new FieldString("terms",filed_options);
