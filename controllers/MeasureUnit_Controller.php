...
class MeasureUnit_Controller extends ControllerSQL{
	public function __construct($dbLinkMaster=NULL){
		...
		$this->setInsertModelId('MeasureUnit_Model');
		...
		$param = new FieldExtString('ext_id'
			...
			$this->addPublicMethod($pm);
			$this->setUpdateModelId('MeasureUnit_Model');
		...
		$this->addPublicMethod($pm);					
		$this->setDeleteModelId('MeasureUnit_Model');
		...
		$this->setListModelId('MeasureUnitList_Model');
		...
		$this->addPublicMethod($pm);
		$this->setObjectModelId('MeasureUnitDialog_Model');		
