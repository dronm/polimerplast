...
class DOCOrder_Controller extends ControllerSQLDOCPl{
	...
	public function __construct($dbLinkMaster=NULL){
		...
		$param = new FieldExtBool('paid'
				,array());
		$pm->addParam($param);
		$param = new FieldExtBool('paid_by_bank'
				,array());
		$pm->addParam($param);
		...
		$param = new FieldExtBool('destination_to_ttn'
				,array());
		$pm->addParam($param);
		$param = new FieldExtFloat('deliv_expenses'
				,array());
		$pm->addParam($param);
		$param = new FieldExtBool('deliv_expenses_edit'
				,array());
		$pm->addParam($param);
		$param = new FieldExtBool('deliv_pay_bank'
				,array());
		$pm->addParam($param);
		...
		$param = new FieldExtString('client_contract_name'
				,array());
		$pm->addParam($param);
		$param = new FieldExtInt('sale_store_address_id'
				,array(
				'alias'=>'Адрес магазина'
			));
		$pm->addParam($param);
		$param = new FieldExtText('order_num'
				,array(
				'alias'=>'Номер заказа'
			));
		$pm->addParam($param);
		$param = new FieldExtText('batch_num'
				,array(
				'alias'=>'Номер партии'
			));
		$pm->addParam($param);
	...
	$opts=array();
		...
		$pm = new PublicMethod('get_current_for_representative_list');
	...
	$opts=array();
		...
		$pm->addParam(new FieldExtText('batch_num',$opts));
	...
	$opts=array();
		...
		$pm->addParam(new FieldExtBool('price_round',$opts));
	...
	$opts=array();
		...
		$pm = new PublicMethod('get_nonegraphic_files_list');
