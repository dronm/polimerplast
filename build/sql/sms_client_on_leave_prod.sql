-- View: sms_client_on_leave_prod

--DROP VIEW sms_client_on_leave_prod;

CREATE OR REPLACE VIEW sms_client_on_leave_prod AS 
	SELECT
		dlv.deliv_date,
		...
		sms_templates_text(
			...
			WHERE t.sms_type='client_on_leave_prod'::sms_types)
		) AS message
	...
	;
ALTER TABLE sms_client_on_leave_prod OWNER TO polimerplast;
