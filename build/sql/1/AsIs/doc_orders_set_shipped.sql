-- FUNCTION: public.doc_orders_set_shipped(integer, character varying, integer, integer, integer, integer, boolean)

-- DROP FUNCTION public.doc_orders_set_shipped(integer, character varying, integer, integer, integer, integer, boolean);
...
ALTER FUNCTION public.doc_orders_set_shipped(integer, character varying, integer, integer, integer, integer, boolean)
