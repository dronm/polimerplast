-- View: sms_client_remind

--DROP VIEW sms_client_remind;

CREATE OR REPLACE VIEW sms_client_remind AS 
	SELECT
		dlv.deliv_date,
		...
		sms_templates_text(
			...
			WHERE t.sms_type='client_remind'::sms_types)
		) AS message
	...
	;
ALTER TABLE sms_client_remind OWNER TO polimerplast;
